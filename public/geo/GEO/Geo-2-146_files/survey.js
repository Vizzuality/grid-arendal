...
if (browser_nav && browser_major==4 && browser_major<6 && (platform_win || platform_mac)) {
	...
	document.write('<layer id="surveybox" visibility="show" width=175 left=' + initLeft + ' top=' + initTop + ' bgColor="#ffffcc" src="http://www.grida.no/include/survey/scorepage.cfm?pageurl=' + window.location + '"></layer>');
	...
	document.write('<iframe name="scoreframe" src="http://www.grida.no/include/survey/scorepage.cfm?pageurl=' + window.location + '" width=175 height=35 frameborder=1 scrolling=no marginwidth=0 marginheight=0 align=center ALLOWTRANSPARENCY="true"></iframe>');
	document.write('</div>');
