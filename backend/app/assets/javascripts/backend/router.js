(function(App) {
  ...
  App.Router = Backbone.Router.extend({
    ...
    routes: {
      ...
      'manage/video_collections': 'BackOfficeHome#index',
      'manage/video_collections/:id/edit': 'BackOfficeHome#show',
      'manage/video_collections/new': 'BackOfficeHome#show',
      'manage/graphics': 'BackOfficeHome#index',
      'manage/graphics/:id/edit': 'BackOfficeHome#show',
      'manage/collections': 'BackOfficeHome#index',
      'manage/collections/:id/edit': 'BackOfficeHome#show',
